...
# Request data of cpi
# Table url: https://www.ine.es/jaxiT3/Tabla.htm?t=76125&L=0
general <- get_data_table(idTable = 76125, filter = filter, unnest = TRUE,
...
# Table url: https://www.ine.es/jaxiT3/Tabla.htm?t=76130&L=0
subyacente <- get_data_table(idTable = 76130, filter = filter, unnest = TRUE,
                             tip = "A", validate = FALSE)
