...
### Example one
We are going to filter the table [Índices nacionales: general y de grupos ECOICOP](https://www.ine.es/jaxiT3/Tabla.htm?t=76125) (Id 76125):
...
```
### Example two
We are going to filter the table [PIB pm Oferta (Indices de volumen encadenado)](https://www.ine.es/jaxiT3/Tabla.htm?t=67822) (Id 67822):
